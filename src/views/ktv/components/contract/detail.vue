      ...
      <span v-if="formData.type == 2">
        ...
        <span v-if="formData.pay_method == 2">
          <van-cell
            title="垫付费用"
            value-class="cellValue"
            :value="formData.substitute_payment | filterUnitB"
          />
          <van-cell title="代垫方" value-class="cellValue" :value="formData.substitute_name" />
          <van-cell
            title="代垫方分润比例"
            value-class="cellValue"
            :value="formData.proportion_of_substitute | filterUnitA"
          />
          <van-cell
            title="场所分润比例"
            value-class="cellValue"
        ...
        <van-cell title="音乐服务费" value-class="cellValue">
          <span slot="label">
            <sweepCodeBillDetail
              ...
              :trial_charging_duration="formData.trial_charging_duration"
            />
          </span>
        </van-cell>
        <cell-image title="合同附件" :dataList="formData.annex"></cell-image>
